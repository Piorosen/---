...
bool SoundClass::Initialize(HWND hwnd, char* file)
{
	bool result;
	...
	result = LoadWaveFile(file, &m_secondaryBuffer1, &m_secondary3DBuffer1);
	if (!result)
	{
		return false;
	}
...
bool SoundClass::PlayWaveFile(float x, float y, float z)
{
	HRESULT result;
