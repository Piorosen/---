...
bool RectClass::InitializeBuffers(ID3D11Device* device, D3DXVECTOR4 color, D3DXVECTOR3 position, D3DXVECTOR3 size)
{
	...
	vertices[3].position = D3DXVECTOR3(position.x, position.y + size.y, 0.0f);
	vertices[3].color = color;

	vertices[4].position = D3DXVECTOR3(position.x + size.x, position.y + size.y, 0.0f);
	vertices[4].color = color;

	vertices[5].position = D3DXVECTOR3(position.x + size.x, position.y, 0.0f);
